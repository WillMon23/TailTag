...
namespace TailTag
{
    class CircleCollider : Collider
    {
        ...
        public override bool CheckCollisionAABB(AABBCollider other)
        {
            ...
            Vector2 direction = Owner.Posistion - other.Owner.Posistion;
            ...
            Vector2 closetsPoint = other.Owner.Posistion + direction;

            //Find the distance from the circle's center to the closest point
            float distanceFromClosestPoint = Vector2.Distance(Owner.Posistion, closetsPoint);
        ...
        {
            Raylib.DrawCircleLines((int)Owner.Posistion.X, (int)Owner.Posistion.Y, CollisionRadius, Color.PINK);
        }
